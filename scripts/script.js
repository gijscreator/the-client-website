...
document.addEventListener("DOMContentLoaded", function() {
  // Afbeeldingen array met alt, naam en locatie
  const images = [
  ...
  list.innerHTML = ""; // zorgt ervoor dat de html zeker weten leeg is

  // Loop door de images en geeft ze weer
